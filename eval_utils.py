...
def moveFeat(cnn_model, data, loader):
...
def eval_split(model, crit, loader, eval_kwargs={}):
    cnn_model = eval_kwargs.get('cnn_model', None)
    ...
    while True:
        ...
        if ensemble:
            tmp = tuple(zip(*[moveFeat(m, data, loader) for m in cnn_model]))
        else:
            tmp = moveFeat(cnn_model, data, loader)
