...
def parse_opt():
    ...
    # Data input settings
    parser.add_argument('--input_json', type=str, default='/kaggle/input/captioncodepy3/data/cocotalk.json',###$$$ cocotalk_pieces.json
                    help='path to the json file containing additional info and vocab')
    parser.add_argument('--input_fc_dir', type=str, default='data/cocotalk_fc',
                    help='path to the directory containing the preprocessed fc feats')
    parser.add_argument('--input_att_dir', type=str, default='/dataset/coco2014_feature_train',
                    help='path to the directory containing the preprocessed att feats')
    parser.add_argument('--input_box_dir', type=str, default='/dataset/coco2014_feature_train_box',
                    help='path to the directory containing the boxes of att feats')
    parser.add_argument('--input_label_h5', type=str, default='/kaggle/input/captioncodepy3/data/cocotalk_label.h5',###$$$ cocotalk_pieces_label.h5
                    help='path to the h5file containing the preprocessed dataset')
    parser.add_argument('--nmt_pretrain', action='store_true',  ###$$$ default False
                        help='whether to use model pretrained in nmt')
    parser.add_argument('--start_from', type=str, default=None,  #/workspace/Transformer_luo/save_rl ###$$$
                    ...
                    """)
    parser.add_argument('--cached_tokens', type=str, default='coco-train-idxs',###$$$ coco-train_pieces-idxs
                    help='Cached token file for calculating cider score during self critical training.')

    # Model settings
    parser.add_argument('--alpha_att', type=, default="transformer",
                    help='value for alpha_att')
    ...
    parser.add_argument('--fix_cnn', type=int, default=0,
                        help='whether to train or fix cnn')
    parser.add_argument('--batch_size', type=int, default=3,#120 25 for p100  80  15  for 2080 ###$$$
                    help='minibatch size')
    ...
    parser.add_argument('--learning_rate', type=float, default=5e-4,#5e-4  1e-5
                    help='learning rate')
    ...
    parser.add_argument('--save_checkpoint_every', type=int, default=10,#3000  ###$$$!!!
                    help='how often to save a model checkpoint (in iterations)?')
    parser.add_argument('--save_history_ckpt', type=int, default=1,
                    help='If save checkpoints at every save point')
    parser.add_argument('--checkpoint_path', type=str, default='/kaggle/working',###$$$
                    help='directory to store checkpointed models')
    parser.add_argument('--language_eval', type=int, default=1,
                    help='Evaluate language as well (1 = yes, 0 = no)? BLEU/CIDEr/METEOR/ROUGE_L? requires coco-caption code from Github.')
    parser.add_argument('--losses_log_every', type=int, default=1500,#1000
                    help='How often do we snapshot losses, for inclusion in the progress dump? (0 = disable)')       
    parser.add_argument('--load_best_score', type=int, default=1,
                    help='Do we load previous best score when resuming training.')       

    # misc
    parser.add_argument('--id', type=str, default='transformer',###$$$
